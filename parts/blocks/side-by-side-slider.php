            ...
            <?php if ( have_rows( 'image_settings' ) ) : ?>
                <?php while ( have_rows( 'image_settings' ) ) : the_row(); ?>
                    ...
                    <div class="h-full flex items-center">
                        <div class="w-full swiperSideBySide swiper-wrapper-div overflow-x-hidden">
                                ...
                                <div class="w-full container mx-auto swiper-wrapper">
                                    <?php foreach ( $images_images as $images_image ): ?>
                                        <div class="swiper-slide w-full flex flex-col bg-white">
                                            <img class="max-w-full shadow-xl object-cover <?php echo $shape . ' ' . $rounding ?>" src="<?php echo esc_url( $images_image['url'] ); ?>" alt="<?php echo esc_attr( $images_image['alt'] ); ?>" />
                                        </div>
                                    <?php endforeach; ?>
                                </div>
                            <?php endif; ?>
